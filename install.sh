...
PACKAGE_NAME="kminoda.autowarefoxgloveconverter-0.0.0"
SOURCE_DIR="."
TARGET_PARENT_DIR="$HOME/.lichtblick-suite/extensions"
TARGET_DIR="$TARGET_PARENT_DIR/$PACKAGE_NAME"
...
cp -r "$SOURCE_DIR" "$TARGET_DIR" # Move it into the parent directory
