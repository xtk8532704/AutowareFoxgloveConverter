...
export const parseConditionNames = (summary: string): string[] => {
...
export function useDLRResult(topicName: string, context: PanelExtensionContext) {
...
export const InfoSection: React.FC<{
  ...
  >
    <h3 style={{ margin: "0 0 12px 0", fontSize: "16px", color: "#495057" }}>{title}</h3>
    {children}
  </div>
);
...
// Common panel layout component
export const DLRPanelLayout: React.FC<{
  result: DLRResultMsg | null;
  allConditions: { [key: string]: any };
  currentFrameConditions: Set<string>;
  lastRawMessage: any;
  debugMode: boolean;
  ...
  >
    ...
    {result ? (
      ...
      >
        ...
        <div style={{ fontSize: "12px", marginTop: "8px" }}>Listening to: {topicName}</div>
      </div>
    )}
  </div>
);
